      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--muted)', lineHeight: 1.7, marginBottom: '1.5rem' }}>
            We sent a confirmation link to <strong style={{ color: 'var(--amber)' }}>{form.email}</strong>. Click it to activate your account.
          </p>
          <Link to="/login" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--muted)', fontSize: '0.875rem', marginBottom: '1.75rem' }}>
            Start tracking your WGU degree progress
          </p>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input
              ...
              onFocus={e => e.target.style.borderColor = form.confirm !== form.password ? 'var(--danger)' : 'var(--amber)'}
              onBlur={e => e.target.style.borderColor = form.confirm && form.confirm !== form.password ? 'var(--danger)' : 'var(--navy-border)'}
            />
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              fontFamily: 'var(--font-display)',
              cursor: loading || !form.email || !form.password || !form.confirm ? 'not-allowed' : 'pointer',
              opacity: !form.email || !form.password || !form.confirm ? 0.5 : 1,
